...
output_path = os.path.join(workspace_root, 'rtl', 'twiddle_rom.v')

with open(output_path, 'w') as f:
    f.write('\n'.join(out) + '\n')

print(f"Generated {os.path.relpath(output_path, workspace_root)} -> {POINTS}-point FFT, {POINTS//2} twiddle factors, addr bus [{ADDR_BITS-1}:0]")
