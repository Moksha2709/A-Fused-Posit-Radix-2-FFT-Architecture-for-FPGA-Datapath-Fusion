...
# 1. Load original unquantized float samples from local copy
...
print("Updated rtl/fp16_add.v with CORRECTED FP15 adder design")

# 3. Compile and Run
print("Running iverilog compilation...")
subprocess.run("iverilog -o sim/sim.out rtl/fp16_add.v rtl/fp16_sub.v rtl/fp16_mul.v rtl/fp16_butterfly.v rtl/fp16_twiddle_rom.v rtl/sample_ram.v rtl/fp16_fft16_top.v sim/tb_fft16.v", shell=True, check=True)
