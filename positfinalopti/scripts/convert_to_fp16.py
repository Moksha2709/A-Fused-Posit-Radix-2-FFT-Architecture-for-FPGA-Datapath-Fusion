...
# Target Floatingpoint directory path
...
N = 16
print(f"Generating FP{N} source files in {fp_dir}...")
...
with open('fp16_fft16_top.v', 'w', encoding='utf-8') as f:
    f.write(top_code)
print("Updated fp16_fft16_top.v parameter N to 16")

# 4. Testbench parameter N and inputs
...
with open('tb_fft16.v', 'w', encoding='utf-8') as f:
    f.write(tb_code_new)
print("Updated tb_fft16.v to FP16 configurations and inputs")

print("\nFolder converted successfully to FP16!")
