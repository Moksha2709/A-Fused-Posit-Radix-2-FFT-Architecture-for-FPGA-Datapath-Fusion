...
set PROJ_NAME "non_fused_posit_fft_N16"
...
# --------------------------------------------------------------------------- #
add_files [list \
    $SRC_DIR/../rtl/fft16_top.v            \
    $SRC_DIR/../rtl/sample_ram.v           \
    $SRC_DIR/../rtl/twiddle_rom.v          \
    $SRC_DIR/../rtl/butterfly.v            \
    $SRC_DIR/../rtl/complex_mult.v         \
    $SRC_DIR/../rtl/POSIT_Multiplier.v     \
    $SRC_DIR/../rtl/POSIT_adder.v          \
    $SRC_DIR/../rtl/POSIT_subtractor.v      \
...
puts ""
puts "============================================================"
puts " NON-FUSED POSIT(16,1) FFT SYNTHESIS SUMMARY"
puts "============================================================"
